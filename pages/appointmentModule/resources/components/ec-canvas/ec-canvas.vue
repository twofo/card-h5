...
<view>
<!-- 新的：接口对其了H5 -->
<canvas v-if="isUseNewCanvas" type="2d" class="ec-canvas" :canvas-id="canvasId" @init="init" @touchstart="ec.disableTouch ? '' : 'touchStart'" @touchend="ec.disableTouch ? '' : 'touchEnd'"></canvas>
<!-- 旧的 -->
<canvas v-else class="ec-canvas" :canvas-id="canvasId" @init="init"></canvas>
</view>
</template>
...
export default {
  ...
  methods: {
    init: function (callback) {
      ...
      const brand = wx.getSystemInfoSync().brand;
      console.log(brand);
      const canUseNewCanvas = compareVersion(version, '2.9.0') >= 0;
      console.log(canUseNewCanvas);
