...
util.Long = require("./long.js");
util.pool = require("./pool.js");
util.float = require("./float.js");
util.asPromise = require("./asPromise.js");
util.EventEmitter = require("./EventEmitter.js");
util.path = require("./path.js");
util.base64 = require("./base64.js");
util.utf8 = require("./utf8.js");
...
util.oneOfSetter = function setOneOf(fieldNames) {
  ...
  return function (name) {
    for (var i = 0; i < fieldNames.length; ++i) if (fieldNames[i] !== name) delete this[
    /*"_"+*/
    fieldNames[i]]; //设置为私有属性
...
Object.defineProperty(util, "decorateRoot", {
  get: function () {
    return roots["decorated"] || (roots["decorated"] = new (require("./root.js"))());
  }
});